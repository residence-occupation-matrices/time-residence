...
`environment/Pipfile` and `environment/Pipfile.lock` record a Python 3.6
Pipenv environment used for part of the analysis. Current installations use
the repository-level `environment.yml` or `pyproject.toml`.
