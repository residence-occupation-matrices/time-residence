"""Portable path defaults for the article's research scripts.

The scripts in this directory originally referred directly to the authors'
workstations. Set ``TIME_RESIDENCE_DATA_DIR`` and
``TIME_RESIDENCE_OUTPUT_DIR`` when the protected inputs or generated outputs
live outside the repository. The defaults point to the repository's ignored
