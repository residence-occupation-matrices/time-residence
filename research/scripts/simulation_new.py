...
def check_varying_n(low=200, high=520, step=1, ax=None):
    for n in tqdm(range(low, high, step)):
        ...
        ax[1][0].plot(t, sol[:, 2, :, 0])  # Asymptomatic
        ax[1][0].plot(t, sol[:, 3, :, 0])  # Symptomatic
...
def final_experiment():
    ...
    # multipatch_var_dict["beta"] /= multipatch_var_dict["N_bar"]+1
    multipatch_var_dict["lamda"] = multipatch_var_dict["mu"] * multipatch_var_dict["N_bar"]
    multipatch_var_dict["E0"] = np.zeros((n, 1))
    # multipatch_var_dict["I0"] = np.zeros((n, 1))
    # indices = rng.integers(low=0, high=n, size=(10))
    # for i in indices:
    #     multipatch_var_dict["I0"][i] = rng.integers(low=0, high=7)
    # indices_asymp = rng.integers(low=0, high=n, size=(10))
    # indices_symp = rng.integers(low=0, high=n, size=(3))
    # indices_severe = rng.integers(low=0, high=n, size=(2))
    # for i in indices_asymp:
    #     multipatch_var_dict["Ia0"][i] = rng.integers(low=0, high=7)
    # for i in indices_symp:
    #     multipatch_var_dict["Is0"][i] = rng.integers(low=0, high=4)
    # for i in indices_severe:
    ...
    beta_mean = multipatch_var_dict["beta"].mean()
    # beta_mean = np.average(multipatch_var_dict["beta"], weights=final_pop.reshape(-1, 1))
    ...
    var_dict["E0"] = 0
    # var_dict["I0"] = rng.integers(low=0, high=10, size=(1,))[0]
    # var_dict["Ia0"] = multipatch_var_dict["Ia0"].sum()
    # var_dict["Is0"] = multipatch_var_dict["Is0"].sum()
    # var_dict["Iw0"] = multipatch_var_dict["Iw0"].sum()
    var_dict["Ia0"] = 0
    var_dict["Is0"] = 1
    var_dict["Iw0"] = 0
    var_dict["R0"] = 0
